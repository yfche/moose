...
class INSFVFluxKernelInterface
{
protected:
  template <typename T>
...
template <typename T>
void
INSFVFluxKernelInterface::initialSetup(T & insfv_fk)
{
...
template <typename T>
void
INSFVFluxKernelInterface::setupFlowBoundaries(T & insfv_fk, const BoundaryID bnd_id)
{
...
template <typename T, typename T2>
void
INSFVFluxKernelInterface::setupBoundaries(T2 & insfv_fk,
                                          const BoundaryID bnd_id,
